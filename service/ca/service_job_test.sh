...
GDNAME="central-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-ca-bs /osm/sh/service_test_process.sh && docker-compose restart taginfo-ca-bs 
...
GDNAME="central-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-ca-mq /osm/sh/service_test_process.sh && docker-compose restart taginfo-ca-mq 
...
GDNAME="central-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-ca-pa /osm/sh/service_test_process.sh && docker-compose restart taginfo-ca-pa 
...
GDNAME="central-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-ca-us-pr /osm/sh/service_test_process.sh && docker-compose restart taginfo-ca-us-pr 
GDNAME="central-america" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-ca-us-vi /osm/sh/service_test_process.sh && docker-compose restart taginfo-ca-us-vi 
