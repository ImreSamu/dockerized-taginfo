...
GDNAME="burundi" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-bi /osm/sh/service_process.sh && docker-compose restart taginfo-af-bi 
...
GDNAME="africa" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-dj /osm/sh/service_process.sh && docker-compose restart taginfo-af-dj 
...
GDNAME="africa" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-er /osm/sh/service_process.sh && docker-compose restart taginfo-af-er 
...
GDNAME="equatorial-guinea" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-gq /osm/sh/service_process.sh && docker-compose restart taginfo-af-gq 
...
GDNAME="south-africa-and-lesotho" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-ls /osm/sh/service_process.sh && docker-compose restart taginfo-af-ls 
...
GDNAME="africa" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-sd /osm/sh/service_process.sh && docker-compose restart taginfo-af-sd 
...
GDNAME="africa" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-so /osm/sh/service_process.sh && docker-compose restart taginfo-af-so 
GDNAME="south-sudan" docker-compose  -f docker-compose-job.yml run --rm taginfo-job-af-ss /osm/sh/service_process.sh && docker-compose restart taginfo-af-ss 
